...
class SecondFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        arguments?.let {
            ...
            if(args.displayImage == 2){
                binding.argImageView.setImageDrawable(resources.getDrawable(R.drawable.android_image_2))
            }
            if(args.displayImage == 3){
                binding.argImageView.setImageDrawable(resources.getDrawable(R.drawable.android_image_3))
            }
        }
    }
